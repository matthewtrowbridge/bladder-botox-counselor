...
export default function ChatWindow({
  ...
  return (
    <main className="flex-1 flex flex-col min-h-0" aria-label="Chat conversation">
      {/* Messages — aria-live for screen reader announcements */}
      <div
      ...
      <div className="border-t border-gray-200 bg-white px-4 py-3 pb-[calc(0.75rem+env(safe-area-inset-bottom))]">
        <form onSubmit={handleSubmit} className="flex gap-2" role="search" aria-label="Send a message">
          <label htmlFor="chat-input" className="sr-only">
            Type your question about bladder treatment
          </label>
          <input
            id="chat-input"
            type="text"
